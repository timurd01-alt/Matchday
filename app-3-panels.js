...
h+=`<div class="edisc">Picks lock at first sighting before kickoff and are never rewritten. In knockout games, model picks are graded by who advances after extra time or penalties; displayed scores stay unchanged. Betting-market comparisons still follow the market's settlement rules. Model output, not betting advice.</div>`;
host.innerHTML=h}
