...
window.SYSTEM_UPDATES=[
 ...
 },
 {
  ...
  "items": [
   "Home shows Matchday's latest calls under the public record: the best recent call against the market and, when there is one, the toughest recent miss. Both come from the same locked, graded picks as the Scorecard.",
   "The model / market list on Home shows the top six differences, so the columns line up without empty space.",
   "X, YouTube and TikTok links sit at the bottom of the navigation, and in the More sheet on phones."
  ]
 },
 {
  "date": "Build 0926V",
 ...
 },
 {
  ...
  "items": [
   "Headers, team names and headline numbers on Home and the welcome page are one to two sizes larger, filling the space the condensed font left.",
   "The top strip, the navigation labels and the welcome footer links now use the label font like every other label."
  ]
 },
 {
  "date": "Build 0926L",
  "tag": "Design",
  "title": "Sharper type roles and brighter welcome page",
  "items": [
   "Each kind of text now has one font everywhere: condensed caps for headers, a monospace face for labels and data, Inter for body copy.",
   "The welcome page is brighter: a white wordmark with a green M, a solid green Enter button, and lighter secondary text.",
   "Home uses the same roles: condensed page title and headline numbers, monospace labels and 'View' links, and tighter corners."
  ]
 },
 {
  "date": "Build 0926K",
 ...
 },
 {
  ...
  "items": [
   "On phones the Conference landscape table keeps every column, including the rating bar, and scrolls sideways instead of squeezing.",
   "Rating vs schedule and Efficiency vs net points per success have a Zoom chart button on phones: full screen, zoom up to 4×, drag to pan, and tap a dot to see the team."
  ]
 },
 {
  "date": "Build 0925N",
 ...
 },
 {
  ...
  "items": [
   "View all games on the home page now spans its column, filling the empty space beside it."
  ]
 },
 {
  "date": "Build 0925L",
 ...
 },
 {
  ...
  "items": [
   "Research's Featured read and the Scorecard's Model record now use the same soft green tint as the home page's game of the week."
  ]
 },
 {
  "date": "Build 0925C",
 ...
 },
 {
  ...
  "items": [
   "New Efficiency vs net points per success chart: how often an offense's snaps succeed against the net expected points each success produces, with one labelled team per quadrant and a Reading the chart panel.",
   "New Defense against a real zero: the best and worst eight defenses by expected points allowed per play, diverging from zero on one scale, with each defense's stop rate.",
   "Matchday in public adds an Against the market record.",
   "Group of Five teams now show as rings rather than a second shade of grey on every scatter chart, and the hover card names each chart's own measures."
  ]
 },
 {
  "date": "Build 0924X",
 ...
 },
 {
  ...
  "items": [
   "Scorecard: the hit rate is drawn against its expected mark and 95% range, and Against the price sits on a scale centred on the 50% coin flip, with Market better and Matchday better on either side.",
   "Scorecard: Against the market shows Agreed and Disagreed as hit-rate bars with an expected tick, in place of the table.",
   "Research: Matchday results is removed (the Scorecard covers it), and Matchday in public now runs full width.",
   "Research: team logos in Risers & fallers, Longshots that won, Reading the chart and the pick list. Footnotes now sit directly under their content."
  ]
 },
 {
  "date": "Build 0924Q",
 ...
 },
 {
  ...
  "items": [
   "The Scorecard now uses the same numbered parts, grid and bordered panels as Research: 01 The record, 02 Against the market, 03 Calibration and results.",
   "Model record and Against the price sit side by side, with the record and hit rate at the same headline size.",
   "Against the market shows its three findings beside the agreed/disagreed table; calibration sits next to the four latest results, and View all opens the rest.",
   "No new metrics; every panel carries the Graded label."
  ]
 },
 {
  "date": "Build 0924N",
