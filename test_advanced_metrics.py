...
class AdvancedMetricTests(unittest.TestCase):
    ...
    def test_basketball_four_factors(self):
        ...
        for game in range(3):
            rows.extend([
                {"game_id": game, "team": "A", "opponent": "B", "points": 110, "fgm": 40, "fga": 80, "three_pm": 10, "fta": 20, "orb": 10, "drb": 30, "tov": 10},
                {"game_id": game, "team": "B", "opponent": "A", "points": 100, "fgm": 35, "fga": 80, "three_pm": 8, "fta": 18, "orb": 8, "drb": 30, "tov": 12},
            ])
