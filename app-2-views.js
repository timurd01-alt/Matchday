...
function factorChips(pr){if(!pr||!pr.why)return '';const L={pts:'points',gd:scoreDiffLabel(),record:'record',margin:'scoring margin',rank:'poll rank',srs:'opponent-adjusted',form:'form',adv:'home',class:(pr.class_meta?.label||'legacy long-term strength').toLowerCase(),market_power:'championship market power',rest:'rest',injuries:'injuries',elo:'elo rating',h2h:'head-to-head'};
