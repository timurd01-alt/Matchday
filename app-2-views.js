...
function factorChips(pr){if(!pr||!pr.why)return '';const L={pts:'points',gd:'goal diff',form:'form',adv:'home',class:'class',rest:'rest',injuries:'injuries',elo:'elo rating',h2h:'head-to-head'};
